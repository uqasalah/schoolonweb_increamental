...
<body>
	<s:actionerror />
	<s:actionmessage />
	<s:form id="formid" name="accessform" action="addAccess" method="post">
		<s:doubleselect id="login_username" formName="accessform" name="roleId"
			doubleName="accessId" list="roleList" doubleList="accessList"

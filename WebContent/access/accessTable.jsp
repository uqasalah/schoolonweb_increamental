	...
	<table class="data display datatable" id="example">
		<thead>
			<tr align="justify" valign="middle" bgcolor="#9966CC" height="50px">
				<th align="left" class="style3"><span class="style3">Accesses</span></th>
				<s:iterator value="roleList" var="user" status="i">
					<th align="left" class="style3"><span class="style3"><s:property
								value="#i.roleName" /></span></th>
				</s:iterator>
			</tr>
		</thead>

		<tbody>
			<s:iterator value="accessList" var="user" status="i">
				<tr align="left"
					class="<s:if test="#i.odd == true">odd gradeX</s:if>1 
				  <s:else>even gradeC</s:else>">
					<td><s:property value="#i.accessTableName" /></td>
				</tr>
			</s:iterator>
		</tbody>
	</table>

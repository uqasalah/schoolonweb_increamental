	...
	<table id="example" class="data display datatable">
		...
		<thead>
			<tr align="justify" valign="middle" bgcolor="#9966CC" height="50px">
				...
				<th align="left" class="style3"><span class="style3">Chapter
						Name</span></th>
		...
		<tbody class="block">
			<s:iterator value="chapterList" var="user" status="i">
				<tr align="left"
				  ...
				  <s:else>even gradeC</s:else>">
					...
					<td><a
						...
						href="deleteChapter?chapter.idChapter=<s:property value="idChapter"/>"><span

...
<title>Add Long Question</title>

</head>
<body>
	<s:actionerror />
	<s:actionmessage />
	<s:form id="formid" name="mcqform" action="addLongQuestion"
		method="post">
		...
		<s:doubleselect id="login_username" formName="mcqform" name="courseid"
		...
		<s:textfield name="question.question" label="Enter Question"
			id="login_username" />
		<s:textarea name="answers[0]" label="Enter Answer" rows="3" cols="30" />

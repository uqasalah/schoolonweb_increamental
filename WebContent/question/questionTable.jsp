	...
	<table id="example" class="data display datatable">
		...
		<thead>
			<tr align="justify" valign="middle" bgcolor="#9966CC" height="50px">
				...
				<th align="left" class="style3"><span class="style3">Question</span>
				</th>
				<th align="left" class="style3">Chapter</th>
				<th align="left" class="style3">Type</th>
				<th align="left" class="style3">Delete</th>
			</tr>
		</thead>
		<tbody class="block">
			<s:iterator value="questions" var="user" status="i">
				<tr align="left"
				  ...
				  <s:else>even gradeC</s:else>">
					...
					<td><s:property value="chapter.chapterName" />
					</td>
					<td><s:property value="tag.tagName" />
					</td>
					<td><a
						onclick="return confirm('Are you sure you want to delete')"
						href="deleteQuestion?question.idQuestion=<s:property value="idQuestion"/>"><span
							class="deleteStyle"><strong>delete </strong> </span>
					</a></td>
				</tr>
			</s:iterator>
		</tbody>

...
<title>All Administrator Accounts</title>
...
<body>
	<s:actionerror />
	<s:actionmessage />
	<table id="contact" border="1" class="data display datatable">
		<thead>
		...
		<tbody class="block">
			<s:iterator value="adminList" var="user" status="i">
				<tr align="left"
				  ...
				  <s:else>even gradeC</s:else>">
					...
					<td><s:if test="blocked == false">
							<a
								onclick="return confirm('Are you sure you want to block user')"
								href="blockAdmin?user.idUser=<s:property value="idUser"/>"><span
								class="blockStyle">Block</span> </a>
						</s:if> <s:else>
							<a onclick="return confirm('Are you sure you want to unblock user')" href="unBlockAdmin?user.idUser=<s:property value="idUser"/>"><span
					...
					<td><a onclick="return confirm('Are you sure you want to delete')"
						href="deleteAdmin?user.idUser=<s:property value="idUser"/>"><span

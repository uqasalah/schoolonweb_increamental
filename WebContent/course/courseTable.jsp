	...
	<table id="example"  class="data display datatable">
		...
		<thead>
			<tr align="justify" valign="middle" bgcolor="#9966CC" height="50px">
				...
				<th align="left" class="style3"><span class="style3">Course
						Name</span>
				</th>
				<th align="left" class="style3">No. of Chapters</th>
				<th align="left" class="style3">Delete</th>
			</tr>
		</thead>
		<tbody class="block">
			<s:iterator value="courseList" var="user" status="i">
				<tr align="left"
				  ...
				  <s:else>even gradeC</s:else>">
					...
					<td><s:property value="chapters.size" />
					</td>
					<td><a  onclick="return confirm('Are you sure you want to delete')"
						href="deleteCourse?course.idCourse=<s:property value="idCourse"/>"><span

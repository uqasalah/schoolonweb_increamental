...
<body>
	...
	<table id="example" class="data display datatable">
		...
		<tbody class="block">
			<s:iterator value="schoolList" var="user" status="i">
				<tr align="left"
				  ...
				  <s:else>even gradeC</s:else>">
					...
					<td><s:if test="blocked == false">
							<a
								...
								href="blockSchool?user.idUser=<s:property value="idUser"/>"><span
								class="blockStyle">Block</span> </a>
						</s:if> <s:else>
							<a
								onclick="return confirm('Are you sure you want to unblock user')"
								href="unBlockSchool?user.idUser=<s:property value="idUser"/>"><span
					...
					<td><a
						...
						href="deleteSchool?user.idUser=<s:property value="idUser"/>"><span
							class="deleteStyle"><strong>delete </strong> </span> </a>
					</td>
